...
class Detail extends React.Component {
    ...
    componentDidMount() {
        ...
        axios({
            ...
            .then(response => {
                this.setState({ restaurants: response.data.restaurants, resId: resId })
    ...
    handleModal = (state, value) => {
        ...
        // if (state == 'galleryModalIsOpen' && value == true) {
    ...
    render() {
        const { restaurants, galleryModalIsOpen, menuItemsModalIsOpen, formModalIsOpen, menuItems, subTotal } = this.state;
        return (<div>
            <div>
                <img src={restaurants.image} alt="No Image, Sorry for the Inconvinience" width="100%" height="300px" />
            ...
            >
                <div>
                    ...
                    <div >
                        ...
                        <button className="btn btn-danger pay" onClick={() => { this.handleModal('formModalIsOpen', true); 
                        this.handleModal('menuItemsModalIsOpen', false) }}> Pay Now</button>
            ...
            >
                <div>
                    ...
                    <div className="resName">{restaurants.name}</div>
